...
export class FacilityComponent implements OnInit {
  facilities: Facility [] = [];
  constructor() {
    this.facilities.push({facilityId: 'DV-1001', facilityName: 'Ocean Suite', area: '85m', cost: '500$', type: 'Room',
      url: 'https://dynamic-media-cdn.tripadvisor.com/media/photo-o/16/9c/59/dc/the-baga-beach-resort.jpg?w=900&h=-1&s=1'});
    this.facilities.push({facilityId: 'DV-1002', facilityName: 'Ocean Suite', area: '85m', cost: '600$', type: 'Room',
    ...
    this.facilities.push({facilityId: 'DV-1003', facilityName: 'Ocean Suite', area: '85m', cost: '500$', type: 'Room',
    ...
    this.facilities.push({facilityId: 'DV-1004', facilityName: 'Ocean Suite', area: '85m', cost: '500$', type: 'Room',
    url: 'http://reviewvilla.vn/wp-content/uploads/2022/03/Ancient-House-Resort-Hoi-An-8.jpg'});
    this.facilities.push({facilityId: 'DV-1005', facilityName: 'Ocean Suite', area: '85m', cost: '500$', type: 'Room',
    url: 'https://statics.vinpearl.com/hinh-anh-vinpearl-resort-spa-nha-trang-bay-3.jpg'});
    this.facilities.push({facilityId: 'DV-1006', facilityName: 'Ocean Suite', area: '85m', cost: '500$', type: 'Room',
    ...
    this.facilities.push({facilityId: 'DV-1007', facilityName: 'Ocean Suite', area: '85m', cost: '500$', type: 'Room',
    url: 'https://www.turtlebayresort.com/sites/default/files/2022-04/Standard_Ocean_View_King_web.jpg'});
    this.facilities.push({facilityId: 'DV-1008', facilityName: 'Ocean Suite', area: '85m', cost: '500$', type: 'Room',
    url: 'https://cdn.vntrip.vn/cam-nang/wp-content/uploads/2018/09/Anja-Beach-Resort-Spa-vntrip3.jpg'});
    this.facilities.push({facilityId: 'DV-1009', facilityName: 'Ocean Suite', area: '85m', cost: '500$', type: 'Room',
